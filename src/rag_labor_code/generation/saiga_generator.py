...
DEFAULT_SYSTEM_PROMPT = (
    ...
    "Российской Федерации. Отвечай только на основании "
    "предоставленного контекста. Не выдумывай нормы права. "
...
def build_rag_user_prompt(
    ...
    return (
        ...
        "Контекст:\n"
        f"{context}\n\n"
        "Сформулируй точный ответ только "
        "по приведённому контексту."
    )
